...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT( /* Qwerty */
    ...
    KC_Z,           KC_X,        KC_C,             KC_V,              KC_B,            KC_GRV,           KC_BSLS,          KC_N,            KC_M,        TD(TD_COMM_BSLS),  KC_DOT,      KC_SLSH,
    SFT_T(KC_LEFT), KC_LSFT,     KC_LGUI,    LT(MEDIA, KC_TAB), LT(NAV, KC_SPC), LT(MOUSE, KC_ESC), LT(SYM, KC_ENT),  LT(NUM, KC_SPC), LT(FUN, KC_BSPC), TD(TD_MINUS_PLUS), KC_QUOT, SFT_T(KC_RGHT)),

/*
| ⛑️  |     |     |     |   |   |   |       | 🔇   |      |       |       |
| CTL | ALT | GUI | SFT |   |   |   | 🎵PRV | 🎵⬇️ | 🎵⬆️ | 🎵NXT | 🎵NXT |
|     |     |     |     |   |   |   | 🎵🛑  | 🎵⏯️ | 🎵🔇 |       |       |
| ⛑️  |     |     |     |   |   | ⏎ | ⇦     | DEL  |      |       |       |
*/
  [MEDIA] = LAYOUT(
    QK_BOOT, _______, _______, _______, _______,                   _______, KC_MUTE, _______, _______, _______,
    KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                   KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MNXT,
  ...
  [NAV] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_SCLN,
    _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_BSLS,
    QK_BOOT, _______, _______, _______, _______, _______, KC_ENT,  KC_SPC,  KC_BSPC,  _______, _______, _______),

  [MOUSE] = LAYOUT(
    QK_BOOT, _______, _______, _______, _______,                   _______, KC_BTN1, KC_BTN2, KC_BTN3, _______,
    KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                   KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______,
